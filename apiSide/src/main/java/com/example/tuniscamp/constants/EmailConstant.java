package com.example.tuniscamp.constants;

public class EmailConstant {
    public static final String SIMPLE_MAIL_TRANSFER_PROTOCOL = "smtps";
    public static final String USERNAME = "wissaltunisiacamp.bot@gmail.com";
    public static final String PASSWORD = "atxihaptkjblikmv";
